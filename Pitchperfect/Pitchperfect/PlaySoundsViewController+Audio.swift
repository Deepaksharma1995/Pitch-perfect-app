...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    func setupAudio() {
        ...
        do {
            audioFile = try AVAudioFile(forReading: recordedAudioURL as NSURL)
        } catch {
    ...
    func showAlert(title: String, message: String) {
        ...
        alert.addAction(UIAlertAction(title: Alerts.DismissAlert, style: UIAlertActionStyle.Default, handler: nil))
